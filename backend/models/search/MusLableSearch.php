...
/**
 * MusLableSearch represents the model behind the search form of `common\models\MusLable`.
 */
class MusLableSearch extends MusLable
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['row_id', 'musician_id', 'label_id', 'state'], 'integer'],
