...
/**
 * BarLabelSearch represents the model behind the search form of `common\models\BarLabel`.
 */
class BarLabelSearch extends BarLabel
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['row_id', 'bar_id', 'label_id', 'state'], 'integer'],
